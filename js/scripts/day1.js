window.day1_script = {
    ...
    day1_hallway_encounter: [
        ...
        { char: "peter", name: "彼得", emotion: "confused", text: "Shit！是誰把這張海報貼歪了？傾斜了 0.5 度！這會破壞整個學校的風水！", effect: "shake" },
        { char: "lanlan", name: "蘭蘭", emotion: "smile", text: "哎呀，彼得好吵呀。燒掉不就好了嗎？", effect: "jump" },
        { char: "ora", name: "奧拉", emotion: "normal", text: "......根據計算，燒掉海報引發火災警報的概率是 98%。安靜點。", effect: "breathe" },
        { text: "那個長髮的男生正拿著水平儀發瘋，旁邊的混血兒手裡玩著打火機，而戴眼鏡的男生則一臉冷漠地看著書。", name: "我" },
        { text: "他們看起來...非常危險。我真的要加入這個社團嗎？", name: "我", next: "day1_class_prompt" }
    ],
    // 初見差分：林恩 (Lynn)
    ...
    day1_meet_peter_class: [
        { bg: "classroom", char: "peter", name: "彼得", emotion: "normal", text: "（正拿著抹布瘋狂擦拭桌角，動作快到出現殘影，嘴裡唸唸有詞）", effect: "shake" },
        { text: "我剛拉開椅子，他就像被電到一樣跳了起來。", name: "我" },
        { char: "peter", name: "彼得", emotion: "surprise", text: "Shit！別過來！你身上帶了多少細菌？！", effect: "jump" },
        { text: "他迅速掏出一瓶藍色的清潔劑，對著我周圍的空氣噴了兩下。", name: "我" },
        { char: "peter", name: "彼得", emotion: "normal", text: "呼...勉強能呼吸了。聽著，庶民。我是彼得，學生會長，也是這裡的國王。", effect: "breathe" },
        { char: "peter", name: "彼得", emotion: "confused", text: "這張桌子我已經消毒了三十遍。如果你敢把指紋印上去，我就把你一起消毒了。" }
    ],
    ...
    day1_meet_lanlan_class: [
        { bg: "classroom", char: "lanlan", name: "蘭蘭", emotion: "normal", text: "哎呀？新同學？", effect: "jump" }, // 改為 normal
        { text: "坐在旁邊的少年笑嘻嘻地看著我，手裡把玩著一個純金的打火機。", name: "我" },
        { text: "那火苗呈現出詭異的青藍色，在他指尖跳躍，卻沒有燒傷他。", name: "我" },
        { char: "lanlan", name: "蘭蘭", emotion: "bored", text: "我是蘭蘭呀！這堂課好無聊，課本上的字像螞蟻一樣爬來爬去，看得我頭暈。", effect: "breathe" },
        { char: "lanlan", name: "蘭蘭", emotion: "smile", text: "吶，我們把課本燒了好不好？我有帶錢，可以賠給學校一百本新的！" } // 改為 smile，因為燒東西開心
    ],
    // Lynn Route (Morning Class)
    ...
    day1_meet_ora_class: [
        ...
        { text: "他正在筆記本上寫著密密麻麻的公式，周圍的空氣彷彿都凝固了。", name: "我" },
        { text: "我試圖打個招呼，但他舉起一隻手制止了我。", name: "我" },
        { char: "ora", name: "奧拉", emotion: "ignore", text: "別說話。你會改變這裡的聲波頻率，干擾我的數據採樣。這是我第 42 次驗算。", effect: "breathe" },
        { char: "ora", name: "奧拉", emotion: "normal", text: "我是奧拉。既然坐在這裡，就保持像石頭一樣的安靜。" }
    ],
    // Lynn Route (Morning Class)
